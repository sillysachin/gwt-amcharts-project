...
public class FunnelChart extends AbstractChartWrapper
{
	public FunnelChart()
	{
		ChartServiceAsync.Util.getInstance()
				.getData( "/data/funnelChart.json", new AsyncCallback<String>()
				{
					@Override
	...
	protected void drawChart( JsArray<JavaScriptObject> chartData )
	{
		...
		amFunnelChart.setMarginRight( 160.0 );
		amFunnelChart.setMarginLeft( 15.0 );
		...
		amFunnelChart.setOutlineThickness( 1.0 );
